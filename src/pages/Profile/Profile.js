...
import { ICON1, ICON2, ICON3, ICON4, ICON5, LOGOUT, MASTERCARD, ONLINESUPPORT, PROFILEBG, PROFILEPIC, WALLET } from '../../constants/images';
        ...
        <ScrollView style={styles.ScrollView} >
          ...
          <View style={styles.MainBox}>
            ...
            <View style={styles.ServiceBoxarea}>
              <View style={styles.ServiceItem}>
                <Pressable style={styles.ServiceBox}>
                  <Image source={MASTERCARD} resizeMode='cover' style={styles.ServiceIcon} />
                  <Text style={styles.ServiceText}>Payment</Text>
                </Pressable>
                <Pressable style={styles.ServiceBox}>
                  <Image source={ONLINESUPPORT} resizeMode='cover' style={styles.ServiceIcon} />
                  <Text style={styles.ServiceText}>Customer Support</Text>
                </Pressable>
                <Pressable style={styles.ServiceBox}>
                  <Image source={WALLET} resizeMode='cover' style={styles.ServiceIcon} />
              ...
              <View style={styles.ManuBox}>
                <Pressable style={styles.MenuList}>
                  <View style={styles.MenuListLeft}>
                    <Image source={ICON1} resizeMode='cover' style={styles.MenuIcon} />
                ...
                <Pressable style={styles.MenuList}>
                  <View style={styles.MenuListLeft}>
                    <Image source={ICON2} resizeMode='cover' style={styles.MenuIcon} />
                ...
                <Pressable style={styles.MenuList}>
                  <View style={styles.MenuListLeft}>
                    <Image source={ICON3} resizeMode='cover' style={styles.MenuIcon} />
                ...
                <Pressable style={styles.MenuList}>
                  <View style={styles.MenuListLeft}>
                    <Image source={ICON4} resizeMode='cover' style={styles.MenuIcon} />
                ...
                <Pressable style={styles.MenuList}>
                  <View style={styles.MenuListLeft}>
                    <Image source={ICON5} resizeMode='cover' style={styles.MenuIcon} />
            ...
            <View style={styles.LogoutBox}>
              ...
              >
                <Image source={LOGOUT} resizeMode='cover' style={styles.LogOutIcon} />
